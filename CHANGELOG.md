...
- Added administrator ownership assignment for tunnels and HTTPS proxy rules from their list pages.
- Added users to configuration backups without exporting passwords or password hashes.
- Added owner usernames to backup tunnel and HTTPS proxy items and restores ownership by username when possible.
